...
public class Main2Dao {
   ...
   public static ArrayList<RoomCategoryVo> getCateAll(){
      ArrayList<RoomCategoryVo> list1 = new ArrayList<RoomCategoryVo>();// 객체 생성
      ...
      try {
         PreparedStatement pstmt = conn.prepareStatement(sql); // sql삽입
   ...
   public static ArrayList<RepresentRoomListVo> getRoom(int cateIdx){
      ArrayList<RepresentRoomListVo> list2 = new ArrayList<RepresentRoomListVo>(); //arraylist객체생성
      Connection conn = DBConnection.getConnection();
