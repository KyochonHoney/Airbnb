 ...
 * Generated at: 2024-02-05 12:18:40 UTC
...
public final class account_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	try{
      ...
      out.write("\t\t<title>계정 관리 - 에어비앤비</title>\r\n");
 ...
 if(userIdx > 0) { 
      ...
      out.write(" · </span>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"profile_timeline.jsp?thisUserIdx=");
      out.print(userIdx);
      out.write("\">프로필로 이동</a>\r\n");
      out.write("\t\t\t\t\t");
 } else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"fl\" style=\"width: 200px;\">로그인부터 해주세요.</div>\r\n");
      out.write("\t\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t</div><!--ê³ì  ë°ì ì´ë¦ë¤-->\r\n");
      out.write("\t\t\t\t</div><!--content_top-->\r\n");
      out.write("\t\t\t\t<div id=\"content_center\">\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"privacy.jsp\"><div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"svg\"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\" aria-hidden=\"true\" role=\"presentation\" focusable=\"false\" style=\"display: block; height: 32px; width: 32px; fill: currentcolor;\"><path d=\"M29 5a2 2 0 0 1 2 1.85V25a2 2 0 0 1-1.85 2H3a2 2 0 0 1-2-1.85V7a2 2 0 0 1 1.85-2H3zm0 2H3v18h26zm-3 12v2h-8v-2zm-16-8a3 3 0 0 1 2.5 4.67A5 5 0 0 1 15 20h-2a3 3 0 0 0-2-2.83V14a1 1 0 0 0-2-.12v3.29A3 3 0 0 0 7 20H5a5 5 0 0 1 2.5-4.33A3 3 0 0 1 10 11zm16 4v2h-8v-2zm0-4v2h-8v-2z\"></path></svg></div><!--svg-->\t\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"explain46\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>개인정보</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>개인정보 및 연락처를 알려주세요</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>로그인 및 보안</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>비밀번호를 변경하고 계정을 안전하게 보호하세요</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>결제 및 대금 수령</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>결제, 대금 수령, 쿠폰, 기프트카드를 검토해주세요.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div>납세자 정보 및 세금 서류 관리</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div>알림 환경설정 및 연락 방식을 선택하세요</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>개인정보 및 공개 설정</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>개인정보, 연결된 서비스 및 데이터 공유 설정 관리</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t</div><!--íìì ëë²ì§¸ div-->\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain46\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>글로벌 환경 설정</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>기본 언어, 통화, 시간대 설정하기</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>출장</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>회사 이메일을 입력하면 출장에서 혜택을 누리실 수 있습니다.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t\t<a class=\"fl\" href=\"OutOfService.jsp\"><div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>전문 호스팅 도구</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>에어비앤비에서 여러 숙소를 관리하신다면 전문 도구를 이용해보세요.</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"explain64\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>추천 크레딧 및 쿠폰</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div>추천 크레딧과 쿠폰이 있습니다. 자세히 알아보기</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div></a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div><!--content_center-->\r\n");
      out.write("\t\t\t\t<div id=\"content_bottom\">\r\n");
      out.write("\t\t\t\t\t<div>계정을 비활성화하셔야 하나요?</div>\r\n");
      out.write("\t\t\t\t\t<a href=\"OutOfService.jsp\">지금 처리하기</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
