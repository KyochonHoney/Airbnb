 ...
 * Generated at: 2024-02-03 10:36:14 UTC
...
public final class Payment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ExpReviewVo rVo = (ExpReviewVo)request.getAttribute("expreviewVO");
      ...
      out.write("		<title>확인 및 결제 &middot; 에어비앤비</title>\r\n");
      ...
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<div id=\"payment_title\">\r\n");
      out.write("			<svg onclick=\"history.back();\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\" aria-label=\"Back\" role=\"img\" focusable=\"false\" style=\"display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 3; overflow: visible;\"><path fill=\"none\" d=\"M20 28 8.7 16.7a1 1 0 0 1 0-1.4L20 4\"></path></svg>\r\n");
      out.write("			<b>확인 및 결제</b>\r\n");
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<div id=\"payment_body\">\r\n");
      out.write("			<div id=\"pb_inner\">\r\n");
      out.write("				<div id=\"pbi_left\">\r\n");
      out.write("					<div id=\"notice\">\r\n");
      out.write("						<div id=\"notice_icon\" class=\"fl\">\r\n");
      ...
      out.write("						</div>\r\n");
      out.write("						<div id=\"notice_text\" class=\"fl\">\r\n");
      out.write("							<div><b>");
      out.print( vo.getLanguage() );
      out.write("</b><b>로 진행되는 체험입니다</b></div>\r\n");
      out.write("							<span>예약하기 전에 진행 언어가 적합한지 확인 하세요.</span>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div style=\"clear:both;\"></div>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"airbnb_or_exp\"><b>체험</b></div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"date\">\r\n");
      out.write("						<b>날짜</b><br/>\r\n");
      out.write("						<div><span>12월 5일 (화)</span> <span>오전 7:00 - 오전 7:45 (KST)</span></div>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"private\">\r\n");
      out.write("						<div id=\"private_title\">\r\n");
      out.write("							<b>내 일행만 참여하는 체험 예약하기</b>\r\n");
      out.write("							<div>\r\n");
      out.write("								<div class=\"fr\"><svg viewBox=\"0 0 12 12\" xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\" role=\"presentation\" focusable=\"false\" style=\"color: #DDD; height: 12px; width: 12px; fill: currentcolor;\"><path d=\"m10.5 1.939 1.061 1.061-7.061 7.061-.53-.531-3-3-.531-.53 1.061-1.061 3 3 5.47-5.469z\"></path></svg></div>\r\n");
      out.write("								<div style=\"clear:both;\"></div>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div id=\"private_text\">\r\n");
      out.write("							<span>프라이빗 예약만을 위한 날짜와 시간입니다.</span> \r\n");
      out.write("							<span>");
      out.print( vo.getExpHostId() );
      out.write("</span>\r\n");
      out.write("							<span>님은 최대</span> \r\n");
      out.write("							<span>");
      out.print( vo.getN() );
      out.write("</span>\r\n");
      out.write("							<span>명까지 모든 규모의 프라이빗 예약을 호스팅할 수 있습니다. 프라이빗 예약 최저 요금: <br/>₩</span>\r\n");
      out.write("							<span>");
      out.print( new DecimalFormat("###,###").format(vo.getExpPrice()) );
      out.write("</span> \r\n");
      out.write("							<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>자세히 알아보기</b></a>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"guest\">\r\n");
      out.write("						<div><b>게스트</b><br/></div>\r\n");
      out.write("						<div>\r\n");
      out.write("							<span>게스트 1명</span>\r\n");
      out.write("							<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\" transform=\"rotate(90)\" aria-hidden=\"true\" role=\"presentation\" focusable=\"false\" style=\"display: block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 4; overflow: visible;\"><path fill=\"none\" d=\"m12 4 11.3 11.3a1 1 0 0 1 0 1.4L12 28\"></path></svg>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"caution\">\r\n");
      out.write("						<div><b>알아두어야 할 사항</b></div>\r\n");
      out.write("						<div>\r\n");
      out.write("							<b>게스트 필수조건</b><br/>\r\n");
      out.write("							<div>\r\n");
      out.write("								<span>");
      out.print( vo.getAge() );
      out.write("세 이상의 게스트 최대</span> \r\n");
      out.write("								<span>");
      out.print( vo.getN() );
      out.write("</span>\r\n");
      out.write("								<span>명 참여 가능</span> \r\n");
      out.write("								<a href=\"#\" style=\"color: #222; text-decoration: underline\"><b>자세히 알아보기</b></a>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      ...
      out.write("						<b>회사 행사로 예약하시나요?</b>\r\n");
      out.write("						<div><div></div></div>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"pay\">\r\n");
      out.write("						<div id=\"pay_title\">\r\n");
      out.write("							<b>결제 수단</b>\r\n");
      out.write("							<div>\r\n");
      out.write("								<img src=\"images/kakaopayLogo.png\"/>\r\n");
      out.write("								<img src=\"images/naverpayLogo.png\"/>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div id=\"pay_select\">\r\n");
      out.write("							<div>\r\n");
      out.write("								<div><img src=\"images/kakaopayLogo.png\"/></div>\r\n");
      out.write("								<div>카카오페이</div>\r\n");
      out.write("							</div>\r\n");
      out.write("							<svg viewBox=\"0 0 18 18\" role=\"presentation\" aria-hidden=\"true\" focusable=\"false\" style=\"height: 16px; width: 16px; fill: rgb(72, 72, 72);\"><path d=\"m16.29 4.3a1 1 0 1 1 1.41 1.42l-8 8a1 1 0 0 1 -1.41 0l-8-8a1 1 0 1 1 1.41-1.42l7.29 7.29z\" fill-rule=\"evenodd\"></path></svg>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div id=\"coupon\">\r\n");
      out.write("							<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>쿠폰 입력</b></a>\r\n");
      out.write("						</div>\r\n");
      out.write("						\r\n");
      out.write("						<div id=\"pay_etc\">\r\n");
      out.write("							<div>\r\n");
      out.write("								<span>아래 버튼을 선택하면</span> \r\n");
      out.write("								<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>게스트 권리 포기서</b></a><span>,</span> \r\n");
      out.write("								<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>환불 정책</b></a><span>,</span> \r\n");
      out.write("								<span>및</span> \r\n");
      out.write("								<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>게스트 환불 정책</b></a>\r\n");
      out.write("								<span>에 동의하는 것입니다.</span>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("						\r\n");
      out.write("						<div id=\"confirm\">\r\n");
      out.write("							<div><b>확인 및 결제</b></div>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("				</div>\r\n");
      out.write("				\r\n");
      out.write("				<div id=\"pbi_right\">\r\n");
      out.write("					<div id=\"pbir_top\">\r\n");
      out.write("						<img class=\"fl\" src=\"");
      out.print( vo.getExpImg1() );
      out.write("\"/>\r\n");
      out.write("						<div id=\"info\" class=\"fl\">\r\n");
      out.write("							<div>온라인 &middot; ");
      ...
      out.write("</span> <span>(후기</span> <span>");
      out.print( rVo == null ? 0 : rVo.getCnt() );
      out.write("</span><span>개)</span></span>\r\n");
      out.write("							</div>\r\n");
      out.write("						</div>\r\n");
      out.write("						<div style=\"clear:both;\"></div>\r\n");
      out.write("					</div>\r\n");
      ...
      out.write("						<div><b>요금 세부정보</b></div>\r\n");
      out.write("						<div>\r\n");
      out.write("							<span>프라이빗 예약 요금</span>\r\n");
      ...
      out.write("						<span><b>총 합계</b> <a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>(KRW)</b></a></span>\r\n");
      out.write("						<span><b><span>₩</span><span>");
      out.print( new DecimalFormat("###,###").format(vo.getExpPrice()) );
      out.write("</span></b></span>\r\n");
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("					<div id=\"refund\">\r\n");
      out.write("						<div><b>환불 정책</b></div>\r\n");
      out.write("						<div>\r\n");
      out.write("							<span>12월 4일</span> <span>오전 7:00 (KST)</span><span>까지 취소하시면 전액 환불됩니다.</span>\r\n");
      out.write("							<a href=\"#\" style=\"color: #222; text-decoration: underline;\"><b>자세히 알아보기</b></a>\r\n");
      out.write("						</div>\r\n");
      out.write("					</div>\r\n");
      out.write("				</div>\r\n");
      ...
      out.write("		</div>\r\n");
      out.write("		\r\n");
      out.write("		<div id=\"payment_footer\">\r\n");
      ...
      out.write("                     <span class=\"fl\">·</span>\r\n");
      out.write("                     <a class=\"fl\">이용약관</a>\r\n");
      out.write("                     <span class=\"fl\">·</span>\r\n");
      out.write("                     <a class=\"fl\">사이트맵</a>\r\n");
      out.write("                     <span class=\"fl\">·</span>\r\n");
      out.write("                     <a class=\"fl\">한국의 변경된 환불 정책</a>\r\n");
      out.write("                     <span class=\"fl\">·</span>\r\n");
      out.write("                     <a class=\"fl\">회사 세부정보</a>\r\n");
      ...
      out.write("                           <a class=\"fl\">한국어 <strong>(KR)</strong></a>\r\n");
      out.write("                        </button><!--언어-->\r\n");
